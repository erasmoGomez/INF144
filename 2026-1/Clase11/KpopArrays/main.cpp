...
//    cin>>precio_mil;
    ...
    cargar_artistas("Data/Artistas.txt",
                    fechas_artistas,
                    codigos_char_artistas,
                    codigos_int_artistas,
                    ratings_artistas,
                    n_artistas);

    probar_artistas("Reports/reporte_prueba_artistas.txt",
                    fechas_artistas,
                    codigos_char_artistas,
                    codigos_int_artistas,
                    ratings_artistas,
    ...
    procesar_reproducciones("Data/Reproducciones.txt",
                            codigos_int_artistas,
                            codigos_canciones,
