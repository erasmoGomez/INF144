...
int main() {
    ...
    // ------------------------------------------------------------
    {
        ...
        cout << "[Bloque 1.1] Ingrese un nombre completo (sin espacios y/o separados por / , - y _ max 29 chars): ";
        cin>>nombre2;
    ...
    // ------------------------------------------------------------
    {
        ...
        char cadena_inicial[100];
        strcpy(cadena_inicial, "Los alumnos de TP");
        strcat(cadena_inicial, " ");
        strcat(cadena_inicial, "van a jalar el lab 6");
        strcat(cadena_inicial, "\n");
        strcat(cadena_inicial, "y el examen parcial!");
