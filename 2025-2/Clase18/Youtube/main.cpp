...
int main() {
    ...
    int n_videos = 0;
    cargar_videos_ordenados("Data/videos.txt", codigos, duraciones, codigos_idioma, n_videos);
...
//               promedios_rating, tasas, n_videos);
    ...
    llenar_nuevos_arreglos_caso_3("Data/CanalesYoutube.txt", codigos, duraciones, codigos_idioma,
                                  fechas_antiguas, fechas_recientes, promedios_rating, tasas,
                                  n_videos);

    imprimir_datos("Reports/reporte_insertar_ordenado_busqueda_binaria.txt",
